**// Exploring results of Mirai Validation output with Gail output
**//16/12/21
**// Olasubomi J. Omoleye

cd /Users/olasubomiomolaye/Desktop/mirai_validation/temp
import delimited "/Volumes/huo-lab/Image/ojomoleye/projects/mirai_validation/data/Mirai_GailComp033022.csv", clear 

count if patient_id !=study_id
drop v1 study_id

rename _year_risk one_year_risk
rename v5 two_year_risk
rename v6 three_year_risk
rename v7 four_year_risk
rename v8 five_year_risk
...
correlate five_year_risk abs_risk
graph matrix five_year_risk abs_risk
spearman five_year_risk abs_risk
sum five_year_risk
sum abs_risk 
...
// AUC and c-indices at different years for gail using Delong et al's method 
roctab case_1 abs_risk
// trick the somersd to get C-index as a proxy of AUC. 
gen censor_1 = 1-case_1 
gen one_year_surv = 1-abs_risk 
tab year_FU case_1
