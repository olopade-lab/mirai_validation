...
**===================================================================================================
import delimited "/Volumes/huo-lab/Image/ojomoleye/projects/mirai_validation/data/Mirai_results_black1116.csv", clear 
...
// revised c-index value for blacks
gen censind5A = 1 - cancer_5 
replace censind5A = 1 if case=="False"
somersd years_to_last_followup five_year_surv , tr(c) cluster(patient_id) ce(censind5A) 
...
**===================================================================================================
import delimited "/Volumes/huo-lab/Image/ojomoleye/projects/mirai_validation/data/Mirai_results_white1116.csv", clear 
...
**===================================================================================================
import delimited "/Volumes/huo-lab/Image/ojomoleye/projects/mirai_validation/data/Mirai_results_hispanic1116.csv", clear 
...
**===================================================================================================
import delimited "/Volumes/huo-lab/Image/ojomoleye/projects/mirai_validation/data/Mirai_results_asianNA1116.csv", clear 
...
// revised c-index for asian and native american
gen censind5A = 1 - cancer_5 
replace censind5A = 1 if case=="False"
somersd years_to_last_followup five_year_surv , tr(c) cluster(patient_id) ce(censind5A)
