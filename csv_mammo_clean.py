...
# %%
metadata_path = "/Users/ojomoleye/olopade_lab/mirai-validation/chimec_mammo_series_metadata.csv"
...
df_s2 = df_sample[columns_to_keep]
...
# %%
#create interim csv
df_s3.to_csv(path_or_buf= "/Users/ojomoleye/olopade_lab/mirai-validation/interim_2_mammoseries.csv")
